  ...
  return (
    <>
        ...
        <section id="about_me" className="h-full flex flex-col justify-between">
          <div className="min-w-[680px] mt-32 lg:px-60 px-20 text-[60px] text-[#fff] lg:text-[80px] font-bold">
            ...
            <section className="flex gap-[10px] items-center -mt-7 md:-mt-2 text-[#CBACF9]">
              ...
              <div className="bg-[#CBACF9] w-[7px] h-[70px] mt-1"></div>
              <p>Developer</p>
            </section>
      ...
      <section className="h-[100vh] flex flex-col justify-center items-center text-[#6D6D6E]">
        ...
        <a href="https://wa.me/952304548" target="_blank" className="text-[#fff] hover:bg-white hover:text-black transition-colors duration-300 text-[20px] mt-10 border rounded-md px-[50px] py-[20px]">{t("contat_button")}</a>

        <ul className="flex gap-16 mt-24">
          <li>
            <a href="https://www.linkedin.com/in/kenneth-de-la-cruz-romero-730833357?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BuSr2JEE8RwyByfDBWC1Otg%3D%3D" target="_blank"><img src={linkeding} alt="" className="w-[50px] hover:invert hover:brightness-0 transition-all duration-300"/></a>
          </li>
          <li>
            <a href="https://www.instagram.com/kennethdr_/" target="_blank"><img src={instagram} alt="" className="w-[50px] hover:invert hover:brightness-0 transition-all duration-300"/></a>
          </li>
          <li>
            <a href="https://github.com/KennethHernan" target="_blank" className="hover:fill-white fill-[#6D6D6E] transition-all duration-300"><img src={github} alt="" className="w-[50px] hover:invert hover:brightness-0 transition-all duration-300"/></a>
          </li>
        </ul>
      </section>
